...
from multipath_bp.utils import logger, unpack_inputs
...
# parse_graph method: find input/output nodes in given computation graph
# parse_module method: same as above
