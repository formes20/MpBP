...
def generate_example(model):
    ...
    # AbstraCMP example.
    with torch.no_grad():
        sd['linear1.weight'][0][0] = -1.0
        sd['linear1.weight'][0][1] = 1.0
        sd['linear1.weight'][1][0] = 1.0
        sd['linear1.weight'][1][1] = -1.0
        sd['linear1.bias'][0] = 0
        sd['linear1.bias'][1] = 0

        sd['linear2.weight'][0][0] = 1.0
        sd['linear2.weight'][0][1] = -1.0
        sd['linear2.weight'][1][0] = 1.0
        sd['linear2.weight'][1][1] = -1.0
        sd['linear2.bias'][0] = 0
        sd['linear2.bias'][1] = 0

        sd['linear3.weight'][0][0] = 1.0
        sd['linear3.weight'][0][1] = -1.0
        sd['linear3.weight'][1][0] = -1.0
