...
def mnist_loaders(batch_size):
    ...
    train_set = datasets.CIFAR10('/data/zhengye/LiRPA_new/examples/vision/data', train=True, download=False,
                                 transform=transforms.Compose([
                                     transforms.RandomHorizontalFlip(),
                                     transforms.RandomCrop(32, 4, padding_mode='edge'),
                                     transforms.ToTensor()]))
    test_set = datasets.CIFAR10('/data/zhengye/LiRPA_new/examples/vision/data', train=False, download=False,
